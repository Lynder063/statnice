...
-- Started on 2024-09-06 20:08:30
...
COPY public.predmet (predmet_id, nazev, popis, okruh_id) FROM stdin;
1	Datové struktury a algoritmy	Algoritmy řazení, asymptotická složitost, vyhledávání, zásobník, fronta, seznamy.	1
2	Diskrétní struktury	Množiny, relace, grafy, stromy, matice, prohledávání grafů.	1
3	Operační systémy	Synchronizace procesů, přidělování procesoru a paměti, souborové systémy.	1
4	Programovací jazyky a překladače	Interpretace a kompilace, lexikální a syntaktická analýza, generování kódu.	1
5	Základy strukturované programování	Algoritmy a jejich zápis, strukturované programování.	1
6	Bezpečnost a ochrana dat	Základy kryptografie, bezpečnostní politika, správa bezpečnosti.	2
7	Objektově orientované programování	Třídy, objekty, dědičnost, polymorfismus.	2
8	Softwarové inženýrství	Vývoj softwaru, životní cyklus, návrhové vzory, testování.	2
9	Řízení softwarových projektů	Modely řízení projektů, agilní metodiky, plánování a rozpočet.	2
10	Tvorba internetových stránek	HTML, CSS, JavaScript, základní frameworky.	2
11	Úvod do databázových systémů	Relační model, SQL, návrh databází.	2
12	Úvod do počítačových sítí	Protokoly TCP/IP, model OSI, směrování a přepínání.	2
13	Návrh a implementace databázových systémů	Pokročilé techniky SQL, indexování, optimalizace dotazů.	3
14	Návrh uživatelských rozhraní	Principy UX, návrh uživatelských rozhraní, prototypování.	3
15	Počítačová grafika a virtuální realita	Renderování, 3D grafika, virtuální realita, herní enginy.	3
16	Podnikové informační systémy	ERP systémy, CRM, správa podnikových zdrojů.	3
17	Webové technologie	HTML5, CSS3, JavaScript, moderní webové frameworky.	3
\.
...
-- Completed on 2024-09-06 20:08:30
